...
\33[33mTienes """ +str(say)+""" Combos..  Elige uno perro!!!
""")
...
print(dosyaa) 
botsay=input("""
   \33[1;96mCuantos Bots Usaras? \33[0m
    \33[1;33mElige entre 1 Y 15
      \33[0m
...
if file.exists ():
    ...
    print("\33[31mArchivo no encontrado.! \33[0m") 
    dosya="yok"
#print(len(feyzo)) 
if dosya=="yok" :
    exit() 
...
#################
panel = input("""
	\33[96mpon tu servidor para escanear \n\n
Servidor:Puerto=\33[0m\33[31m\33[1m""")
#=======+++=++++++====++=======
...
kanall=""
kanall=input("""
deseas incluir las categorias de canales?
1= si
2= no
Respuesta=""")
if not kanall=="1":
...
def onay(veri,user,pas):
		...
		sound="/sdcard/sound/Doomchaingun.mp3"
...
def yaz(kullanici): 
    dosya=open('/sdcard/Hits/aless/ஜ۞ஜ💥🆃🅰🅽🅺3️⃣🔥ஜ۞ஜ   👉  '         +fx+ '.txt','a+') 
...
╭─➝  \33[32m 💥█▓ 𝐀𝐋𝐄𝐒𝐒 𝐌𝟑𝐔-𝐒𝐂𝐀𝐍𝐍𝐄𝐑 ▓█💥      
├➝ \33[1;32m\33[36m 𝕊𝕖𝕣𝕧𝕚𝕕𝕠𝕣 🖥️: \33[0m\33[1;50;33m"""+portal+"""\33[32m     
├➝ 💂🔑 𝐔𝐬𝐞𝐫/𝐏𝐚𝐬𝐬: \33[0m\033[32m """ +user+""":"""+pas+"""
├➝ \33[33m 𝐇𝐢𝐭 ☞ """ + str(hit) + """ \33[32m \033[0m \33[1;31m%"""+str(oran)+"""  \33[1;94mCPM ☞ """+str(cpm)+"""  \33[32m
├➝ \33[33m 📕 """+str(dsyno)+str(dosyaa)+"""     \33[33m
╰─➝  \33[95m  🚘 """+str(bot)+"""\33[1;36m ⛽ Total ☞ """+str(fyz)+"""  \33[32m

       😃 ︻╦╤─ જ⁀➴
 🚩     ███████]▄▄▄▄▄▄▄▄💥💥💥["""+str(hit)+"""]\33[0m\33[1;50;33m
⣿⣿  ▄▅█████████▅▄▃▂        
[███████████████████]
   ◥⊙▲🅐▲🅛▲🅔▲🅢▲🅢▲⊙◤
""")
